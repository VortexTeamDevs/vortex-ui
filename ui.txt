...
if Camera.ViewportSize.X > 774 and Camera.ViewportSize.Y > 503 then
	MainSize = UDim2.fromOffset(337, 212)  -- %50 mini
	MinSize = UDim2.fromOffset(250, 21)    -- %50 mini
else
	MainSize = UDim2.fromOffset((Camera.ViewportSize.X - 100) * 0.5, (Camera.ViewportSize.Y - 100) * 0.5)  -- %50 küçült
	MinSize = UDim2.fromOffset((Camera.ViewportSize.X - 275) * 0.5, 21)  -- %50 mini
end
